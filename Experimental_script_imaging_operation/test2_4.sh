...
libcamera-still --width 2312 --height 1736 --datetime -n -o /media/raspberry4/Raspi_USB/slotimaging/well4/Data2 --contrast 1.0 --brightness 0.1 --shutter 3000 --denoise off --awbgains 1.5,2.0
