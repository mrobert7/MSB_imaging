...
libcamera-still --width 2312 --height 1736 --datetime -n -o /media/raspberry4/Raspi_USB/slotimaging/well5/Data4 --contrast 1.0 --brightness 0.1 --shutter 500 --denoise off
